...
#NPI parte 2
##barplot()
plot(DS$sum_gamerounds[DS$version == "gate_30"])
plot(DS$sum_gamerounds[DS$version == "gate_40"])
```
...
#Observed statistic
diffmeans = (meanGameroundsGate30 - meanGameroundsGate40)
